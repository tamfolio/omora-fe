...
const testimonials = [
  ...
  },
  {
    ...
    testimonial:
      "I've known the founder for years, and his brilliance shows in OMORA. He doesn't cut corners. The portfolio logic, the AI triggers and the user education are all intentional. i trust this more than  any exchange-based product i've seen.",
    stars: 5,
  ...
  },
  {
    ...
    testimonial:
      "Working on Omora has been different. It's one of the few products i've helped build that i'd also recommend to my own family. We've obsessively tested performance scenarios and risk handling and it shows in how smooth it feels.",
    stars: 5,
  ...
  },
  {
    ...
    testimonial:
      "As someone who invests across sectors, i need a platform that handles crypto volatility intelligently. Omora's AI powered rebalancing and yield strategies are a dream and i've already recommended it to my investment circle",
    stars: 5,
    img: "/assets/images/website/avatar-2.png",
  },
  {
    ...
    role: "Design Lead",
    testimonial:
      "From the beginning, we agreed Omora had to feel like wealth, not like another exchange. The UI was designed to feel personal and trustwortht, and watching people use what we've built with confidence has been deeply rewarding.",
    stars: 5,
    img: "/assets/images/website/avatar-2.png",
  },
  {
