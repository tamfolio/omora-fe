  ...
  return (
    <section className="py-24 px-[112px]">
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-[#00717D] font-semibold text-base mb-3">
            Our Insights
          </h2>
          <p className="text-[36px] text-[#181D27] font-semibold mb-5">
            Curated by Omora just for you
          </p>
          <p className="text-[20px] font-normal mb-24">
            Smart crypto insights curated by us, simplified for clarity and
            confident decisions
          </p>
        </div>
        <Button className="bg-[#008B99] hover:bg-[#008B99] px-[18px] py-3 rounded-[8px]">
          View all posts
        </Button>
      </div>
        ...
        {insights.map((insight, index) => (
          ...
          >
            <Image
              ...
              height={256}
            />
            <span className="text-[#00717D] font-semibold text-base mt-4 mb-2 block">
              {insight.tag}
            </span>
            <div className="flex items-center justify-between mb-1">
              <h3 className="text-[#181D27] text-[18px] font-semibold">
                {insight.title}
              </h3>
              <Image
            ...
            <p className="text-[#535862] text-base font-normal mb-5">
              {insight.description}
            </p>
            <div className="flex items-center gap-2 mt-5">
              ...
              />
              <div>
                <span className="block text-[#181D27] text-sm font-semibold">
                  {insight.name}
                </span>
                <span className="block text-[#535862] text-sm font-normal">
                  {insight.date}
                </span>
              </div>
            </div>
