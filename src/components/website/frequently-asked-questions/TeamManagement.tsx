...
const teamManagementFaqs = [
    {
        ...
        answer: "Yes. Admins can add Operators and assign permissions via “Manage Users."
    },
    {
        question: "What's the difference between Admin and Operator roles?",
        answer: "Admins control the full wallet, team permissions, and approve transactions. Operators have limited rights like initiating requests or viewing transactions."
    },
    {
    ...
    {
        question: "How do I deactivate or update an operator's permissions?",
        answer: " Operators can initiate requests, but cannot complete withdrawals or conversions without Admin approval."
    },
    {
        question: "Will Operators receive login credentials via email?",
        answer: "Yes. Once added by the Admin, they get a welcome email with setup instructions."
    },
]
