...
const gettingStartedFaqs = [
    {
        ...
        answer: "Individuals and corporate users receive a virtual NGN account to fund, which can then be converted to USDT at the prevailing market rate."
    },
    {
        question: "Do I need to complete a risk profile before investing?",
        answer: "Yes. It's a short form to tailor your experience and unlock investing features"
    },
    {
        question: " What happens after I fund my wallet?",
        answer: "You’ll receive a confirmation email. Then, your funds are either left as balance or converted to USDT and auto-invested based on your settings."
    },
    {
  ...
  return (
    ...
    >
      {gettingStartedFaqs.map((faq, index) => (
        <AccordionItem className={`${faq.question === gettingStartedFaqs[gettingStartedFaqs.length - 1].question ? "border-none" : ""}`} key={index} value={`item-${index + 1}`}>
