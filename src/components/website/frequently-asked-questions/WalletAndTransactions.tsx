...
const walletAndTransactionsFaqs = [
  {
    ...
    answer:
      "Once your account is verified, you can fund your NGN wallet using bank transfer. Your funds can then be converted to USDT to begin investing.",
  },
  {
    question: "How do I convert NGN to USDT or vice versa?",
    answer:
      "Simply click “Convert” on your wallet dashboard, enter the amount, and confirm with 2FA.",
  },
  {
    question: "Where can I view my wallet and transaction history?",
    answer:
      "In your dashboard under “Wallet” → “Transaction History” with filter options and downloadable reports.",
  },
  {
    question: "Can I withdraw anytime?",
    answer:
      "You can withdraw your NGN wallet balance at any time. For USDT, withdrawals are only allowed after your investment tenor ends.",
  },
  {
    question: "What is the FX conversion rate?",
    answer:
      "We use live market rates for all conversions (on-ramp and off-ramp).",
  },
  {
    question: " How do I track fees charged by Omora?",
    answer:
      "Every transaction shows a breakdown, including fees charged. You can also download your full fee summary.",
  },
  {
  ...
  return (
    ...
    >
      {walletAndTransactionsFaqs.map((faq, index) => (
        <AccordionItem
          className={`${faq.question === walletAndTransactionsFaqs[walletAndTransactionsFaqs.length - 1].question ? "border-none" : ""}`}
          key={index}
          value={`item-${index + 1}`}
        >
