...
export default function CookiesPopUp() {
  ...
  return (
    <div
      className={`fixed z-20 bottom-8 right-8 rounded-[20px] bg-[#00717D] p-6 text-[#ECFEFF] w-[488px] ${hasAcceptedCookies ? "hidden" : "block"}`}
    >
      ...
      <div className="flex justify-between">
        <Button
          ...
          className="w-[212px] px-[18px] py-3 rounded-[8px] text-base hover:bg-[#008B99] bg-[#008B99]"
        >
          Reject non-essentials
        </Button>
        <Button className="w-[212px] px-[18px] py-3 rounded-[8px] text-base hover:bg-white bg-white text-[#155E75]">
          Accept
        </Button>
      </div>
    </div>
