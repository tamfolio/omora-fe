          ...
          {currentStep === "select" ? (
            <>
              ...
              <p className="text-sm text-gray-600 mb-6">
                Please select ALL the security methods that are unavailable and
              ...
              <div className="space-y-3 mb-6">
                {VERIFICATION_METHODS.map((method) => (
                  ...
                  >
                    <div
                      className={`flex-shrink-0 ${method.enabled ? "text-gray-600" : "text-gray-400"}`}
                    >
                      <method.icon className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div
                        className={`font-medium ${method.enabled ? "text-gray-900" : "text-gray-500"}`}
                      >
                        {method.title}
                      </div>
                      {method.description && (
                        <div
                          className={`text-sm ${method.enabled ? "text-gray-500" : "text-gray-400"}`}
                        >
                          {method.description}
                        </div>
                      )}
