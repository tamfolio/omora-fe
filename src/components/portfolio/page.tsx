    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-8">
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-900">Based on your Risk Profile</span>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-8">
            <div className="grid grid-cols-3 gap-8 mb-6">
              <div>
                <div className="text-sm text-gray-600 mb-1">Wallet Balance (USDC)</div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-600">Conversion Rate: 1 USD = ₦1,3800</div>
              <button className="text-sm text-blue-600 hover:text-blue-700">Charges</button>
            </div>
          </div>
          ...
          <div className="col-span-4 border-l border-gray-200 pl-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                {[
                  { symbol: 'BTC', percent: '45%', value: '$56,631', change: '+8.2%', color: 'bg-blue-500' },
                  { symbol: 'ETH', percent: '45%', value: '$56,631', change: '+8.2%', color: 'bg-orange-500' },
                  { symbol: 'LTC', percent: '45%', value: '$56,631', change: '-8.2%', color: 'bg-green-500' },
                  { symbol: 'XRP', percent: '45%', value: '$56,631', change: '+8.2%', color: 'bg-red-500' },
                ].map((asset, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 ${asset.color} rounded-full`}></div>
                      <span className="text-sm text-gray-600">{asset.symbol} ({asset.percent})</span>
                    </div>
              ...
              <div className="space-y-4">
                {[
                  { symbol: 'SOL', percent: '45%', value: '$56,631', change: '-8.2%', color: 'bg-purple-500' },
                  { symbol: 'SUI', percent: '45%', value: '$56,631', change: '-8.2%', color: 'bg-indigo-500' },
                  { symbol: 'CRO', percent: '45%', value: '$56,631', change: '-8.2%', color: 'bg-blue-400' },
                  { symbol: 'AVAX', percent: '45%', value: '$56,631', change: '-8.2%', color: 'bg-red-400' },
                ].map((asset, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className={`w-2 h-2 ${asset.color} rounded-full`}></div>
