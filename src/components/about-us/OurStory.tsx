        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-7">
              ...
              at donec. In turpis vel at quam imperdiet. Ipsum molestie aliquet 
              sodales id est ac volutpat.
            </p>

            <p className="text-gray-600 leading-7">
              Odio felis sagittis, morbi feugiat tortor vitae feugiat fusce aliquet. 
              Nam elementum urna nisi aliquet erat dolor enim. Ornare id morbi 
              eget ipsum. Sapien, dictum molestie sem tempor. Diam elit, orci, 
              tincidunt aenean tempus. Quis velit eget ut tortor tellus. Sed vel, 
          ...
          <div className="space-y-6">
            <p className="text-gray-600 leading-7">
              ...
              Auctor rutrum lacus molestie ornare et. Vulputate 
              consectetur ac ultrices at diam dui eget fringilla tincidunt. Arcu sit 
              dignissim massa erat cursus volutpat gravida id. Sed quis auctor 
            ...
            <p className="text-gray-600 leading-7">
              ...
              id. Non pellentesque congue eget consectetur turpis. Sapien, 
