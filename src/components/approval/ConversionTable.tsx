...
const ConversionTable = ({ title }: ConversionTableProps) => {
  ...
  const [selectedTransaction, setSelectedTransaction] = useState<ConversionTransaction | null>(null);
  ...
  // Mock data
  const transactions: ConversionTransaction[] = [
    { id: 1, requestedBy: "Williams Jane", amountNGN: 5000, projectedUSDT: 5000, conversionRate: 1530, timestamp: new Date(2025, 6, 15, 12, 0) },
    { id: 2, requestedBy: "John Doe", amountNGN: 10000, projectedUSDT: 10000, conversionRate: 1530, timestamp: new Date(2025, 6, 14, 15, 30) },
    { id: 3, requestedBy: "Alice Smith", amountNGN: 7500, projectedUSDT: 7500, conversionRate: 1530, timestamp: new Date(2025, 6, 13, 9, 45) },
    { id: 4, requestedBy: "Bob Johnson", amountNGN: 3000, projectedUSDT: 3000, conversionRate: 1530, timestamp: new Date(2025, 6, 12, 14, 20) },
    { id: 5, requestedBy: "Sarah Williams", amountNGN: 15000, projectedUSDT: 15000, conversionRate: 1530, timestamp: new Date(2025, 6, 11, 11, 15) },
    { id: 6, requestedBy: "Mike Brown", amountNGN: 8000, projectedUSDT: 8000, conversionRate: 1530, timestamp: new Date(2025, 6, 10, 16, 45) },
    { id: 7, requestedBy: "Emily Davis", amountNGN: 12000, projectedUSDT: 12000, conversionRate: 1530, timestamp: new Date(2025, 6, 9, 10, 30) },
    { id: 8, requestedBy: "David Wilson", amountNGN: 9500, projectedUSDT: 9500, conversionRate: 1530, timestamp: new Date(2025, 6, 8, 13, 0) },
  ];
  ...
  const sortedTransactions = React.useMemo(() => {
    ...
    return [...transactions].sort((a, b) => {
      ...
      } else if (column === 'amountNGN' || column === 'projectedUSDT' || column === 'conversionRate') {
        // Numbers, keep as is
  ...
  const columns = [
    ...
    { key: 'amountNGN', label: 'Amount NGN', sortable: true },
    { key: 'projectedUSDT', label: 'Projected USDT', sortable: true },
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredTransactions.map((transaction) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-[#535862]">
                    NGN {transaction.amountNGN.toLocaleString()}
                  </td>
                  <td className="px-6 py-4 text-sm text-[#535862]">
                    {transaction.projectedUSDT.toLocaleString()} USDT
                  </td>
                  <td className="px-6 py-4 text-sm text-[#535862]">
                    1 USDT = NGN {transaction.conversionRate.toLocaleString()}
                  </td>
