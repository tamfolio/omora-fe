...
export default function CookieSettings() {
  ...
  const handleSave = () => {
    localStorage.setItem('omora-cookie-consent', JSON.stringify({
      accepted: true,
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                ...
                They enable core functionality like authentication, security, and accessibility.
              </p>
            </div>
            <div className="ml-4">
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                Help us understand how visitors interact with our platform by collecting and
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                Used to track visitors across websites and display personalized ads and content
                that are relevant to you. May be set by third-party advertising partners.
              </p>
            </div>
            <button
