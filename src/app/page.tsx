...
const whyOmora = [
  {
    ...
    description: "Deposit into your Stanbic IBTC virtual account. No wallet setup needed.",
    icon: "/assets/images/website/message-chat-circle.svg"
  },
  {
    title: "AI-Driven Portfolio",
    description: "Our risk engine profiles you and recommends a smart, diversified portfolio.",
    icon: "/assets/images/website/zap.svg"
  },
  {
    title: "Daily Auto-Investments",
    description: "No timing stress. We invest daily using dollar-cost averaging (DCA).",
    icon: "/assets/images/website/chart-breakout-square.svg"
  },
  {
    title: "Fully Compliant & Secure",
    description: "KYC, AML, and real custody are all handled with trusted partners.",
  ...
  return (
    <main>
      ...
      <section className="bg-[#FAFAFA] text-center py-20 space-y-10">
        <h2 className="text-[20px] font-medium">BACKED BY PARTNERS WHO BELIEVE IN SMARTER CRYPTO INVESTING</h2>
        <div className="flex gap-10 items-center justify-center">
          <Image src="/assets/images/website/partners/pennytree.png" width={251} height={48} alt="pennytree" />
          <Image src="/assets/images/website/partners/treegar.png" width={173} height={48} alt="treegar" />
          <Image src="/assets/images/website/partners/quidax.png" width={199} height={48} alt="quidax" />
          <Image src="/assets/images/website/partners/stanbic-ibtc.png" width={275} height={48} alt="stanbic-ibtc" />
        </div>
        <p className="w-[784px] mx-auto text-base font-medium">The companies listed represent current partners, infrastructure providers, and integrations and do not imply investment in Omora products.</p>
      </section>
      <section className="py-24 px-[112px]">
        <h3 className="font-semibold text-[#00717D] text-base mb-3">Why Omora?</h3>
        <p className="font-medium text-[#181D27] max-w-[868px] text-wrap text-[36px] leading-[44px] mb-5">Simplify your crypto investing. Stay compliant. Grow smarter.</p>
        <p className="font-normal text-[20px] text-[#535862] mb-16">Omora automates your crypto journey from funding to daily investment.</p>
            ...
            <div key={index} className="bg-[#FAFAFA] p-6">
              <div className="mb-16">
                <div className="size-12 flex justify-center items-center bg-[#008B99] rounded-[10px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.08),_0px_-2px_0px_0px_rgba(255,255,255,0.6)_inset,_0px_0px_0px_1px_rgba(0,0,0,0.06)_inset]">
                  <Image src={why.icon} alt={why.title} width={24} height={24} />
                </div>
              </div>

              <h4 className="font-semibold text-[18px] text-[#181D27] mb-1">{why.title}</h4>
      ...
      <section className="py-24 text-center bg-[#FAFAFA]">
          <h2 className="max-w-[768px] mx-auto font-semibold text-[36px] mb-5">Your next move deserves more than guesswork</h2>
          <p className="font-normal text-[20px] mb-8">Join over 1,000+ investors who are growing their portfolios with Omora.</p>
